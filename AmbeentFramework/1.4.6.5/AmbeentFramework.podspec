Pod::Spec.new do |spec|
  ...
  #  spec.source = { :http => "https://github.com/Ambeent/-iOS-CocoaPods-Repository/raw/main/AmbeentXC/AmbeentXCv1.4.7/AmbeentFramework.xcframework.zip" }
  #  spec.source = { :http => "https://github.com/Ambeent/-iOS-CocoaPods-Repository/raw/main/frameworkToSimulator/AmbeentFramework.xcframework.zip" }
    spec.source = { :http => "https://github.com/Ambeent/-iOS-CocoaPods-Repository/raw/main/CompiledFramework/v1.4.6.5/AmbeentFramework.xcframework.zip" }
