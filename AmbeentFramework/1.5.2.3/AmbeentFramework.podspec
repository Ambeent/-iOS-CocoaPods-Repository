Pod::Spec.new do |spec|
  ...
  # spec.source = { :http => "https://github.com/Ambeent/-iOS-CocoaPods-Repository/raw/main/OlderVersions/AmbeentFramework.framework.zip" }
    spec.source = { :http => "https://github.com/Ambeent/-iOS-CocoaPods-Repository/raw/main/AmbeentXC/AmbeentXCv1.5.2.3/AmbeentFramework.xcframework.zip" }
